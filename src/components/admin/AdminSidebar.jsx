...
const groups = [
  ...
  { label: 'Operations', items: [{ href: '/cp-adm-7f92mk3x/chat', label: 'Live Chat' }, { href: '/cp-adm-7f92mk3x/business-settings', label: 'Business Settings' }, { href: '/cp-adm-7f92mk3x/audit-log', label: 'Audit Log' }] },
];
